...
import { UserCog, Pencil, ChevronRight } from "lucide-react";
...
function EmployeesPermission({ user, rolePermissions, permissions }) {
    return (
        <div>
                    ...
                    <Table>
                                    ...
                                    <div className="flex items-center justify-between px-4 py-6">
                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            <Button variant="outline">
                                                {rolePermissions.from}-
                                                {rolePermissions.to} of{" "}
                                                {rolePermissions.total}
                                            </Button>
                                            <Select
                                                defaultValue={String(
                                                    rolePermissions.per_page
                                                )}
                                                onValueChange={(value) => {
                                                    router.get(
                                                        "/dashboard/employees",
                                            ...
                                            {permissions.includes(
                                                ...
                                                <Link
                                                    href={`/dashboard/employees/permissions/${user.id}`}
                                                >
                                                    <Button
                        ...
                        <TableBody>
                            {rolePermissions.data.length > 0 ? (
                                rolePermissions.data.map((permission, idx) => (
                                    <TableRow
                                        key={idx}
